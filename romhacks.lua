...
romhacks = {
    ...
    },
    {
        ...
        shortName = "coop-mods-green-stars",
        water = false,
        levels = {
            {
                name = "bop",
            ...
            },
            {
                ...
                pipes = {
                    {
                        { x = -4328, y = -1840, z = 8086 },
                        { x = -4942, y = -1082, z = 2635 }
                    },
                    {
                        { x = 3080, y = -2147, z = 951 },
                    ...
                    {
                        { x = -1193, y = -2692, z = -3216 },
                        { x = -2607, y = -165, z = -2516 }
                    },
                    {
                        { x = -1536, y = -690, z = 1076 },
                        { x = 1897, y = 1808, z = -3202 }
                    }
                }
            },
            {
                ...
                pipes = {
                    {
                        { x = -2753, y = 1890, z = 3230 },
                        { x = 2995, y = -2713, z = 308 }
                    },
                    {
                        { x = -4699, y = -1026, z = 4790 },
                        { x = 1420, y = 723, z = 5108 }
                    }
                },
                unwantedBhvs = { id_bhvExclamationBox }
             },
             {
                ...
                pipes = {
                    {
                        { x = 1520, y = -3003, z = -3368 },
                        { x = 1471, y = -609, z = 2927 }
                    },
                    {
                        { x = 1535, y = 90, z = 4741 },
                        { x = 1500, y = 1833, z = 3685 }
                    }
                },
            ...
            },
            {
                ...
                pipes = {
                    {
                        { x = 5333, y = -666, z = -3070 },
                        { x = 6874, y = 1496, z = 5103 }
                    },
                    {
                        { x = -187, y = 3281, z = 8034 },
                        { x = -9462, y = 2147, z = 7156 }
                    },
                    {
                        { x = -259, y = -4866, z = -9364 },
                        { x = -9613, y = -666, z = -3713 }
            ...
            },
            {
                ...
                pipes = {
                    {
                        { x = 4610, y = -719, z = -5389 },
                        { x = 2209, y = -2266, z = 1731 }
                    },
                    {
                        { x = 3962, y = -2266, z = 3861 },
                        { x = -4531, y = 7533, z = 4903 }
                    }
                },
                unwantedBhvs = { id_bhvBigBullyWithMinions, id_bhvFireSpitter },
            },
            {
                name = "pc",
                level = LEVEL_TTM,
                ...
                pipes = {
                    ...
                    {
                        { x = 6297, y = 1751, z = 5767 },
                        { x = 873, y = 293, z = -913 }
                    },
                    {
                        { x = 603, y = 8, z = -10281 },
                        { x = 9492, y = 2619, z = -10621 }
                    },
                    {
                        { x = 4480, y = -712, z = -5059 },
                        { x = 178, y = -733, z = -11477 }
            ...
            },
            {
                name = "misty",
                level = LEVEL_THI,
                painting = get_texture_info("painting_gs_misty"),
                area = 1,
                pipes = {
                    {
                        { x = 1651, y = -4363, z = -4040 },
                        { x = 4881, y = 2167, z = -3697 }
                    },
                    {
                        { x = -810, y = -169, z = 6688 },
                        { x = -1372, y = -4136, z = 6615 }
                    },
                    {
                        { x = 5078, y = 2251, z = 1404 },
                        { x = -203, y = 3826, z = -2384 }
                    },
                    {
                        { x = 1386, y = 3826, z = 1517 },
                        { x = 6786, y = -4005, z = -1854 }
                    }
                },
                unwantedBhvs =  { id_bhvExclamationBox, id_bhvPlatformOnTrack, id_bhvTrackBall },
            },
            {
                name = "cq",
                level = LEVEL_TTC,
                ...
                pipes = {
                    ...
                    {
                        { x = -1908, y = -2075, z = 2755 },
                        { x = -184, y = 6001, z = -5109 }
                    },
                    {
                        { x = -4556, y = -617, z = 5491 },
                        { x = 6634, y = -3125, z = -2473 }
                    }
                },
            ...
            },
            {
                ...
                pipes = {
                    ...
                    {
                        { x = 3615, y = -969, z = 51 },
                        { x = 4774, y = 1592, z = 5505 }
                    },
                    {
                        { x = 3468, y = -969, z = -1578 },
                        { x = 4961, y = 2192, z = -4465 }
                    }
                },
