...
romhacks = {
    -- don't edit these
    {
        ...
        levels = {
            ...
            { name = "rhmc",     level = LEVEL_HMC,            painting = get_texture_info("rhmc_painting"),  area = 1, pipes = nil, spawnLocation = { x = 4050, y = 0, z = 4981 }, overrideName = "Red's In HMC", room = 2,  unwantedBhvs = { id_bhvHmcElevatorPlatform }, disabledBhvs = { id_bhvDoor } },
            ...
            { name = "ithi",     level = LEVEL_THI,            painting = get_texture_info("ithi_painting"),  area = 3, pipes = nil, overrideName = "Wiggler's Cave" },
    ...
    },
    {
        ...
        water = false,
        levels = {
            { name = "tc",      level = LEVEL_CASTLE_COURTYARD, painting = get_texture_info("painting_74_tc"),    area = 1, pipes = { { { x = -1701, y = -441, z = 825 },  { x = 3957, y = 1147, z = -5545 } } }, overrideName = "The Courtyard" },
            { name = "tt",      level = LEVEL_CASTLE,           painting = get_texture_info("painting_74_cmf"),    area = 1, pipes = { { { x = -132, y = 2088, z = 3645 },  { x = 2130, y = -942, z = -2502 } } }, overrideName = "The Temple", unwantedBhvs = { id_bhvExclamationBox } },
            { name = "tote",    level = LEVEL_WMOTR,            painting = get_texture_info("painting_74_tote"),    area = 1, pipes = { { { x = -3279, y = -1578, z = 2961 },  { x = 5533, y = 3503, z = 3982 } } } },
            { name = "df",      level = LEVEL_BOB,              painting = get_texture_info("painting_74_df"),    area = 1, pipes = { { { x = 4066, y = -1014, z = -1968 },  { x = -1061, y = 1742, z = -1475 } } }, unwantedBhvs = { id_bhvExclamationBox } },
            { name = "moj",     level = LEVEL_WF,               painting = get_texture_info("painting_74_moj"),    area = 1, pipes = { { { x = -4770, y = 2571, z = 830 },  { x = 466, y = -3174, z = -1439 } } } },
            { name = "tmss",    level = LEVEL_CCM,              painting = get_texture_info("painting_74_tmss"),    area = 1, pipes = { { { x = 4271, y = -894, z = -4988 },  { x = -5825, y = 737, z = -1065 } } } },
            { name = "tsod",    level = LEVEL_COTMC,            painting = get_texture_info("painting_74_tsod"),    area = 1, pipes = { { { x = -3489, y = -468, z = 2831 },  { x = -3374, y = 1226, z = -2423 } } } },
            { name = "cc",      level = LEVEL_SA,               painting = get_texture_info("painting_74_cc"),    area = 1, pipes = { { { x = 119, y = 1778, z = -1989 },  { x = 2082, y = -1640, z = 1542 } } } },
            { name = "thr",     level = LEVEL_BBH,              painting = get_texture_info("painting_74_thr"),    area = 1, pipes = { { { x = 2376, y = -1094, z = 1838 },  { x = 88, y = 3458, z = 345 } } } },
            { name = "bbb",     level = LEVEL_BITDW,            painting = get_texture_info("painting_74_bbb"),    area = 1, pipes = { { { x = 4437, y = -963, z = -3643 }, { x = 2405, y = 3966, z = 1787 } } } },
            { name = "dlss",    level = LEVEL_LLL,              painting = get_texture_info("painting_74_dlss"),    area = 1, pipes = { { { x = -1068, y = -2779, z = -5432 }, { x = 1091, y = 11934, z = 579 } } } },
            { name = "tpss",    level = LEVEL_SSL,              painting = get_texture_info("painting_74_tpss"),    area = 1, pipes = { { { x = -1467, y = 3763, z = 5607 }, { x = -5109, y = -1298, z = -1876 } } } },
            { name = "sc",      level = LEVEL_HMC,              painting = get_texture_info("painting_74_sc"),    area = 1, pipes = { { { x = 2636, y = 243, z = 3280 }, { x = 177, y = 2672, z = 4133 } }, { { x = -448, y = -7166, z = -2908 }, { x = -2713, y = -278, z = -6712 } } } },
            { name = "fg",      level = LEVEL_DDD,              painting = get_texture_info("painting_74_fg"),    area = 1, pipes = { { { x = -3957, y = 1908, z = -4284 }, { x = -397, y = -856, z = 2018 } }, { { x = 4315, y = -58, z = 5617 }, { x = 2894, y = 1676, z = -3565 } } } },
            { name = "bac",     level = LEVEL_BITFS,            painting = get_texture_info("painting_74_bac"),    area = 1, pipes = { { { x = 1534, y = -2455, z = -28 }, { x = 1610, y = 1399, z = 2051 } } } },
            { name = "cof",     level = LEVEL_TTM,              painting = get_texture_info("painting_74_cof"),    area = 1, pipes = { { { x = -2405, y = 2944, z = -593 }, { x = 1189, y = -2197, z = 996 } } } },
            { name = "ss",      level = LEVEL_SL,               painting = get_texture_info("painting_74_ss"),    area = 1, pipes = { { { x = -5908, y = 3391, z = 4342 }, { x = -3111, y = -1704, z = -2754 } } } },
            { name = "sb",      level = LEVEL_WDW,              painting = get_texture_info("painting_74_sb"),    area = 1, pipes = { { { x = 3180, y = -558, z = 300 }, { x = 4198, y = 3231, z = -4779 } } } },
        }
    },
    {
        -- ported to tag by Murioz
        ...
        levels = {
            ...
            { name = "sss",   level = LEVEL_SA,             painting = get_texture_info("painting_sr_sss"),    area = 1, pipes = { { { x = 4227, y = 3532, z = 2296 },  { x = 5688, y = -6010, z = -5545 } }, { { x = -4812, y = 1267, z = 3239 }, { x = 6144, y = 1123, z = -3292 } }, { { x = -2300, y = -2344, z = -242 }, { x = 1104, y = -3944, z = 1930 } } } },
