...
romhacks = {
    ...
    },
    {
        ...
        levels = {
            ...
            { name = "castle1", level = LEVEL_CASTLE,           painting = get_texture_info("cg_painting"),    area = 1, pipes = { { { x = -132, y = 2088, z = 3645 },  { x = 2130, y = -942, z = -2502 } } } },
            { name = "wmotr",   level = LEVEL_WMOTR,            painting = get_texture_info("cg_painting"),    area = 1, pipes = { { { x = -3279, y = -1578, z = 2961 },  { x = 5533, y = 3503, z = 3982 } } } },
            ...
            { name = "cotmc",   level = LEVEL_COTMC,            painting = get_texture_info("cg_painting"),    area = 1, pipes = { { { x = -3489, y = -468, z = 2831 },  { x = -3374, y = 1226, z = -2423 } } } },
            ...
            { name = "bitdw",   level = LEVEL_BITDW,            painting = get_texture_info("cg_painting"),    area = 1, pipes = { { { x = 4437, y = -963, z = -3643 }, { x = 2433, y = 3966, z = 1643 } } } },
            ...
            { name = "ddd",     level = LEVEL_DDD,              painting = get_texture_info("cg_painting"),    area = 1, pipes = { { { x = -3957, y = 1908, z = -4284 }, { x = -5315, y = -856, z = -801 } } } },
            { name = "bitfs",   level = LEVEL_BITFS,            painting = get_texture_info("cg_painting"),    area = 1, pipes = { { { x = 3156, y = 101, z = -6847 }, { x = 1610, y = 1399, z = 2051 } } } },
            { name = "ttm",     level = LEVEL_TTM,              painting = get_texture_info("cg_painting"),    area = 1, pipes = { { { x = -2405, y = 2944, z = -593 }, { x = 1189, y = -2197, z = 996 } } } },
            { name = "sl",      level = LEVEL_SL,               painting = get_texture_info("cg_painting"),    area = 1, pipes = { { { x = -5908, y = 3391, z = 4342 }, { x = -3111, y = -1704, z = -2754 } } } },
            { name = "wdw",     level = LEVEL_WDW,              painting = get_texture_info("cg_painting"),    area = 1, pipes = { { { x = 3180, y = -558, z = 300 }, { x = 4198, y = 3231, z = -4779 } } } },
        }
    },
    {
        -- ported to tag by Murioz
